...
// Only need to define the JSON path now
const outPath = path.join(__dirname, 'public', 'parking-status.json');

// Set this to "free" or "used" depending on how you want bars rendered (still needed for logic)
...
    // === Write outputs atomically (ONLY JSON REMAINS) ===
    ...
    console.log('Generated public/parking-status.json');
  } catch (err) {
